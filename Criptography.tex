...
\author{Oscar~Dussan,~David~Rodas,~Jessid~Mejia,~and~Camilo~Gonzalez\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Your~Name is with the Department of ...,
...
\markboth{Introduction to Crytography}{Your Name \MakeLowercase{\textit{et al.}}: Your Title}
